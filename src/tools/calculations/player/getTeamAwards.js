...
const list1 = [
    ...
    {'id':'team2','title':'Should Be a Slave','desc':'the person would win the most more often if they just started the best projection','keyID':'wins gained if slave','rate':'gp','MinMax':'max','meta':['name']},
    {'id':'team2.1','title':"Don't Become A Slave",'desc':'the person would win the least more often if they just started the best projection','keyID':'wins gained if slave','rate':'gp','MinMax':'min','meta':['name']},
    {'id':'team3','title':'Should Be a Slave1','desc':'the person would gain the most points/game if they just started the best projection','keyID':'pts gained if slave','rate':'gp','MinMax':'max','meta':['name']},
    {'id':'team3.1','title':"Don't Become A Slave1",'desc':'the person would gain the fewest points/game if they just started the best projection','keyID':'pts gained if slave','rate':'gp','MinMax':'min','meta':['name']},
