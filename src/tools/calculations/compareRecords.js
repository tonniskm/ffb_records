...
export function CompareRecords(records,oldRecords){
    ...
    const list = [['nameAwards','name'],['gameAwards','wy'],['weekAwards','wy'],['yearAwards','year'],['nyAwards','ny'],['projAwards','nwy'],['playerStats','name'],['draftAwards','name'],
    ['teamAwards','name'],['fiddleAwards','name']]
