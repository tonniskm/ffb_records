...
export function getNameAwards(vars,input){
    ...
    const list = [
            ...
            {'id': 'na13', 'title': 'Super High Score!', 'description': 'The most yearly high scores', 'keyID': 'Yearly High Scores', 'MinMax': null},
            {'id': 'na14', 'title': 'Pathetic', 'description': 'The most yearly low scores', 'keyID': 'Yearly Low Scores', 'MinMax': null},
